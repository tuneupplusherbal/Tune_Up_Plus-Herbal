...
export const BENEFITS: Benefit[] = [
  {
    ...
    description: 'Formed from rich natural micro-nutrients, our capsules create a sturdy protective shield. Helps defensive cells actively block modern seasonal cold, flu, and toxic pathogens without chemical aid.',
    iconName: 'Shield',
    suitableFor: ['16+ Years', 'Adults', 'Seniors'],
  },
  {
    id: 'energy-stamina',
  ...
  },
  {
    ...
    description: 'Infuses organic calcium, Moringa compounds, and anti-inflammatory ginger active elements to lubricate joints, soothe persistent muscle aches, and assist in comfortable walking and daily activities.',
    iconName: 'Activity',
  ...
  },
  {
    ...
    description: 'Features natural therapeutic adaptogens like Ashwagandha and Zafran that stabilize erratic mood hormones, dissolve stress blocks, and enable working professionals and students (16+) to maintain focus.',
    iconName: 'Brain',
    suitableFor: ['16+ Years', 'Adults'],
  },
  {
  ...
  },
  {
    ...
    description: 'Effectively reduces internal body swelling, bloating, and excess weight naturally, making the body active, light, and balanced.',
  ...
  },
  {
    ...
    subtitle: 'گرتے بالوں کا قدرتی علاج',
    description: 'Reduces hair fall rates, provides natural minerals and vitamins to hair follicles, making hair strong, thick, and healthy for teens (16+) and adults.',
    iconName: 'hair-fall',
    suitableFor: ['16+ Years', 'Adults'],
  },
  {
